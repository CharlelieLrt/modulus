...
A number of library-wide improvements have been made to make models easier to
use, debug, and maintain. Documentation and examples have been improved, and
models now systematically use `jaxtyping` for shape-aware tensor annotations
alongside more informative type hints for type checkers. Tensor shape validation
has been standardized at the start of forward passes to make debugging easier,
test suites have been expanded to improve API stability, and support for saving
and loading checkpoints has been enhanced across model types. Finally, coding
standards have been tightened in ways that are consistent and enforceable
(including by AI coding agents) to improve the developer experience.
