...
`HuggingFace Diffusers <https://huggingface.co/docs/diffusers>`_ or
`timm <https://huggingface.co/docs/timm>`_ by writing a thin wrapper, or by
using :meth:`~physicsnemo.core.module.Module.from_torch` to convert a
