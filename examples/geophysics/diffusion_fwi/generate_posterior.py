...
def main(cfg: DictConfig) -> None:
    ...
    sampler_fn = partial(
                ...
                std = 1e-1,gamma_cond=1e-2, mu=1,scale=1/10,power=2
            )

    # Create output directory
    output_path = Path(to_absolute_path(cfg.io.output_dir+"_posterior"))
    output_path.mkdir(parents=True, exist_ok=True)

    # Main generation loop
    rank_zero_logger.info("Starting generation...")
